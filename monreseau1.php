...
<h4> <strong> <u> Amis : <br> <br></u> </strong>  </h4>
...
if ($db_found) {
	$sql = "SELECT Nom, PhotoProfil FROM auteur ORDER BY Nom ";
	$result = mysqli_query($db_handle, $sql); 

	while ($data = mysqli_fetch_assoc($result)) {
		echo  '<img src= "'.$data['PhotoProfil'].'"  class="img-circle" width="100" height="100" >' ;
		echo  ' ' .$data['Nom'] .'<br>'.'<br>';
